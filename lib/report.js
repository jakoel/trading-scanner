...
export function formatTelegramMessages(results) {
  ...
  // Trend combo above. RSI Reclaimed 30 and Bullish Divergence + Strong Trend
  // have no display anywhere at all as of 2026-09-22 — see "Removed" below
  // for why. detectMacdSignals()/detectRsiSignals()/detectDivergenceSignals()
  // still tag every occurrence of all three for data/signals.csv research logging.
