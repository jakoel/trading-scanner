...
export function formatTelegramMessages(results) {
  ...
  // No standalone MACD Turned Green or RSI Reclaimed 30 section. MACD Green
  // alone (52-61% win depending on horizon) and RSI Reclaim alone (52-62%,
  // barely better than a coin flip at 10d even after the ADX gate) are both
  // weaker than the confluence sections they feed into, so both only surface
  // here via a combo, never on their own.
